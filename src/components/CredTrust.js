...
import "../style/CredTrust.css";
const CredTrust = () => {
  return (
    <div className="cred-turst">
      <div className="max-width cred-trust-content">
        <h1 className="cred-trust-heading">
          the story of CRED begins with trust.
        </h1>
        <div className="cred-trust-description">
